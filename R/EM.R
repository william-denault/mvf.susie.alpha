...
#
# @param zeta joint assignment probabilities for each covariate. The same
#   E-step weights are used for every modality because the causal covariate is
...
{
  if (!is.numeric(zeta)) {
    stop("zeta must be the numeric vector of joint SNP assignment probabilities")
  }
